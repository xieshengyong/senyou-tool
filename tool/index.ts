...
export function push(category: string, action: string, label: string, value?: string, e?: any, el?: any) {
  ...
  var _value = value || "";
  // @ts-ignore
  if (typeof _czc !== "undefined") _czc.push(["_trackEvent", _category, _action, _label, _value]);
  // @ts-ignore
  if (typeof _tdga !== "undefined") _tdga.addEvent(_category, _action, _label, _value, e, el);
  // @ts-ignore
  if (typeof PTTSendClick !== "undefined") PTTSendClick(category, action, label);
}
 ...
 */
export const debounce = (fn: Function, delay = 200, content = this) => {
